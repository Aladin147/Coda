...
class VoiceSettings(BaseModel):
    ...
    # Moshi settings
    moshi_model_path: str = Field(
        default="kyutai/moshika-pytorch-bf16", env="MOSHI_MODEL_PATH"
    )
...
class ConfigurationManager:
    ...
    def validate_config(self, config: VoiceConfig) -> Dict[str, Any]:
        ...
        validation_results = {"valid": True, "warnings": [], "errors": [], "recommendations": []}
        ...
        try:
            ...
            if config.audio.sample_rate < 16000:
                validation_results["warnings"].append("Low sample rate may affect audio quality")
