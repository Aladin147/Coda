...
from .hybrid_orchestrator import HybridOrchestrator, HybridConfig, ProcessingStrategy, ResponseSelection
...
class HybridBalancedMode(ProcessingModeInterface):
    ...
    def __init__(
        ...
        self.configs = (hybrid_config, moshi_config, context_config, llm_config, optimization_config)
    ...
    def get_mode_info(self) -> ProcessingModeConfig:
        ...
        return ProcessingModeConfig(
            ...
            auto_select_conditions={
                "default": True  # Good default choice
            }
        )
