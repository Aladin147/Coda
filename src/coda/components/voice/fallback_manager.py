...
class FallbackConfig:
    ...
    emergency_response_text: str = "I'm experiencing technical difficulties. Please try again later."
...
class FallbackManager:
    ...
    def _find_fallback_rule(self, failure_type: FailureType, component: str) -> Optional[FallbackRule]:
    ...
    def _record_failure(self, failure_event: FailureEvent) -> None:
        ...
        if len(self.component_failures[failure_event.component]) > 100:
            self.component_failures[failure_event.component] = \
                self.component_failures[failure_event.component][-100:]
