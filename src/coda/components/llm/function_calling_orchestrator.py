...
class FunctionCallingOrchestrator(FunctionCallingOrchestratorInterface):
    ...
    async def process_function_calls(
        self, function_calls: List[FunctionCall], context: Optional[Dict[str, Any]] = None
    ...
    def parse_function_calls_from_response(self, response: LLMResponse) -> List[FunctionCall]:
        """
    ...
    async def validate_function_call(self, function_call: FunctionCall) -> bool:
        """
    ...
    async def _execute_function_call(
        self, function_call: FunctionCall, context: Optional[Dict[str, Any]] = None
    ) -> FunctionCallResult:
    ...
    async def execute_function_calls_parallel(
        ...
        tasks = [self._execute_function_call(call, context) for call in function_calls]
