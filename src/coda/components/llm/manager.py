...
from .providers import OpenAIProvider, AnthropicProvider, OllamaProvider, LocalModelProvider
...
class LLMManager(LLMManagerInterface):
    ...
    async def generate_response(
        ...
        **kwargs
        ...
        try:
            ...
            functions = None
            if self.config.function_calling.enabled and self._tool_manager:
    ...
    async def _generate_single_response(
        ...
        **kwargs
        ...
        if response.has_function_calls() and self.config.function_calling.auto_execute:
    ...
    async def _process_function_calls(self, response: LLMResponse, conversation_id: str) -> None:
        ...
        try:
            ...
            logger.info(f"Processed {len(function_calls)} function calls for conversation {conversation_id}")
