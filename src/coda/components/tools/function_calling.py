...
class FunctionCallingManager(FunctionCallingInterface):
    ...
    def parse_function_call(self, function_call_data: Dict[str, Any]) -> ToolCall:
        ...
        try:
            ...
            if "name" in function_call_data and "arguments" in function_call_data:
                ...
                raise ValueError("Invalid function call format: missing 'name' and 'arguments' or 'function'")
    ...
    def validate_function_call(self, function_call: Dict[str, Any], available_tools: List[str]) -> bool:
        """
        ...
        try:
            ...
            if tool_call.tool_name not in available_tools:
                logger.warning(f"Function call validation failed: tool {tool_call.tool_name} not available")
                return False
    ...
    def parse_multiple_function_calls(self, function_calls_data: List[Dict[str, Any]]) -> List[ToolCall]:
        """
    ...
    def format_multiple_tool_results(self, results: List[ToolResult], for_llm: bool = True) -> List[Dict[str, Any]]:
        """
